...
Describe "Convert-PropertyElement" {
    It 'should have a parameter named Property that is mandatory and accepts a System.Xml.XmlElement object.' {
        Get-Command "$commandName" | Should -HaveParameter Property -Mandatory -Type 'System.Xml.XmlElement'
    }
}